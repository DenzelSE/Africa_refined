...
export default function PopupOrderForm({ product, onSuccess, onCancel }: OrderFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormSuccess("Your order has been placed successfully! We will contact you shortly to confirm your order.")
      ...
      setFormError("An error occurred while placing your order. Please try again.")
    } finally {
